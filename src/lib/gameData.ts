...
export const NEWS_SCRIPT = [
  ...
  { day: 1, minute: 6, headline: 'Day 1 closes with broad-based gains — sentiment turns bullish', detail: 'All sectors end in green. Analysts predict strong follow-through tomorrow.', impact: { IT: 0.9, Banking: 0.8, Pharma: 0.6, Energy: 0.5, FMCG: 0.7 } },
  ...
  { day: 2, minute: 2, headline: 'BREAKING: US Fed signals rate cut — global markets euphoric', detail: 'Powell hints at 3 rate cuts in 2025. Tech and financial stocks go parabolic.', impact: { IT: 4.5, Banking: 3.9, Pharma: 0.8, Energy: 1.4, FMCG: 0.6 } },
  ...
  { day: 2, minute: 5, headline: 'Retail investors pouring money in — market breadth at 10-year high', detail: 'SIP inflows hit ₹22,000 Cr monthly record. Everyone is buying.', impact: { IT: 2.8, Banking: 2.6, Pharma: 1.2, Energy: 1.8, FMCG: 1.1 } },
  { day: 2, minute: 6, headline: "Day 2 closes at record highs — 'Bull run has just begun' say experts", detail: 'Nifty up 3.8% in single session. TV anchors declare new era of growth.', impact: { IT: 2.1, Banking: 1.9, Pharma: 0.8, Energy: 1.2, FMCG: 0.9 } },
  ...
  { day: 3, minute: 2, headline: 'Inflation data comes in higher than expected — rate cut hopes fade', detail: 'CPI at 6.2% vs 5.8% expected. Markets confused — was the rally premature?', impact: { IT: -2.1, Banking: -2.8, Pharma: 0.7, Energy: -0.9, FMCG: 0.8 } },
  { day: 3, minute: 3, headline: 'Reliance Industries announces massive capex — stock falls on concerns', detail: '₹75,000 Cr investment plan announced. Investors worried about near-term returns.', impact: { IT: -0.4, Banking: -0.6, Pharma: 0.5, Energy: -2.4, FMCG: 0.6 } },
  ...
  { day: 4, minute: 2, headline: 'BREAKING: US economy enters technical recession — Dow futures -800 pts', detail: 'GDP contracts for second consecutive quarter. Global risk-off mode triggers.', impact: { IT: -7.2, Banking: -5.8, Pharma: -0.9, Energy: -5.4, FMCG: -0.6 } },
  { day: 4, minute: 3, headline: 'FII selling at record pace — ₹12,000 Cr outflows in single session', detail: 'Foreign funds exit Indian markets. Rupee hits all-time low vs dollar.', impact: { IT: -4.1, Banking: -6.9, Pharma: -0.7, Energy: -3.8, FMCG: -0.5 } },
  { day: 4, minute: 4, headline: 'HDFC Bank CEO resigns — governance scandal rocks banking sector', detail: 'Shock resignation amid audit irregularities. Banking stocks in free fall.', impact: { IT: -2.3, Banking: -8.4, Pharma: -0.4, Energy: -2.1, FMCG: 0.8 } },
  { day: 4, minute: 5, headline: 'Pharma & FMCG emerge as safe havens amid market carnage', detail: 'Defensive sectors attract panic buyers. HUL, Sun Pharma buck the trend.', impact: { IT: -3.1, Banking: -4.2, Pharma: 2.8, Energy: -2.9, FMCG: 2.4 } },
  { day: 4, minute: 6, headline: 'Day 4 bloodbath — IT down 18%, Banking down 22% from Day 2 peak', detail: "Worst single-day fall in 5 years. Those who didn't sell are praying.", impact: { IT: -4.2, Banking: -3.8, Pharma: 1.1, Energy: -3.4, FMCG: 1.3 } },
  { day: 5, minute: 1, headline: 'Dead cat bounce — markets attempt recovery after historic crash', detail: 'Bargain hunters cautiously enter. But is it too early?', impact: { IT: 2.1, Banking: 2.4, Pharma: 0.8, Energy: 1.6, FMCG: 0.5 } },
  ...
  { day: 5, minute: 3, headline: 'IT sector reality check — recovery will take months say analysts', detail: 'Deal pipelines slow. IT stocks fail to sustain morning bounce.', impact: { IT: -1.8, Banking: 0.9, Pharma: 1.4, Energy: 1.1, FMCG: 1.6 } },
  { day: 5, minute: 4, headline: 'Britannia, HUL, Dabur hit 52-week highs — FMCG the clear winner', detail: 'Consumer staples prove resilient. Those who held FMCG are smiling.', impact: { IT: -0.6, Banking: 0.4, Pharma: 1.9, Energy: 0.8, FMCG: 4.1 } },
  ...
  { day: 5, minute: 6, headline: 'MARKET CLOSED — Final results are in. Who played it smart?', detail: 'The simulation ends. Defensive players and early exiters come out on top.', impact: { IT: 0.5, Banking: 0.4, Pharma: 0.8, Energy: 0.6, FMCG: 0.9 } },
]
